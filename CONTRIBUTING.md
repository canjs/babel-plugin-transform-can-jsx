# Contributing to babel-plugin-transform-can-jsx

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/babel-plugin-transform-can-jsx) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork babel-plugin-transform-can-jsx, you can start by going to its [fork page](https://github.com/canjs/babel-plugin-transform-can-jsx/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/babel-plugin-transform-can-jsx
```
...
```shell
cd babel-plugin-transform-can-jsx
```
